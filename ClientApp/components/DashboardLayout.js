...
import { AcademicCapIcon, ArrowLeftOnRectangleIcon, Bars3Icon, BuildingOfficeIcon, CalendarIcon, ChartPieIcon, ClipboardDocumentListIcon, Cog6ToothIcon, HomeIcon, UserGroupIcon, XMarkIcon } from '@heroicons/react/24/outline';
...
const DashboardLayout = ({ session, children }) => {
    ...
    return (_jsxs("div", { children: [_jsx(Transition.Root, { show: sidebarOpen, as: Fragment, children: _jsxs(Dialog, { as: "div", className: "relative z-50 lg:hidden", onClose: setSidebarOpen, children: [_jsx(Transition.Child, { as: Fragment, enter: "transition-opacity ease-linear duration-300", enterFrom: "opacity-0", enterTo: "opacity-100", leave: "transition-opacity ease-linear duration-300", leaveFrom: "opacity-100", leaveTo: "opacity-0", children: _jsx("div", { className: "fixed inset-0 bg-gray-900/80" }) }), _jsx("div", { className: "fixed inset-0 flex", children: _jsx(Transition.Child, { as: Fragment, enter: "transition ease-in-out duration-300 transform", enterFrom: "-translate-x-full", enterTo: "translate-x-0", leave: "transition ease-in-out duration-300 transform", leaveFrom: "translate-x-0", leaveTo: "-translate-x-full", children: _jsxs(Dialog.Panel, { className: "relative mr-16 flex w-full max-w-xs flex-1", children: [_jsx(Transition.Child, { as: Fragment, enter: "ease-in-out duration-300", enterFrom: "opacity-0", enterTo: "opacity-100", leave: "ease-in-out duration-300", leaveFrom: "opacity-100", leaveTo: "opacity-0", children: _jsx("div", { className: "absolute left-full top-0 flex w-16 justify-center pt-5", children: _jsxs("button", { type: "button", className: "-m-2.5 p-2.5", onClick: () => setSidebarOpen(false), children: [_jsx("span", { className: "sr-only", children: "Close sidebar" }), _jsx(XMarkIcon, { className: "h-6 w-6 text-white", "aria-hidden": "true" })] }) }) }), _jsxs("div", { className: "flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 pb-4 ring-1 ring-white/10", children: [_jsx("div", { className: "flex h-16 shrink-0 items-center", children: _jsx("span", { className: "text-xl font-bold text-white", children: "ScheduleCentral" }) }), _jsx("nav", { className: "flex flex-1 flex-col", children: _jsx("ul", { role: "list", className: "flex flex-1 flex-col gap-y-7", children: _jsx("li", { children: _jsx("ul", { role: "list", className: "-mx-2 space-y-1", children: filteredNav.map((item) => (_jsx("li", { children: _jsxs(NavLink, { to: item.href, onClick: () => setSidebarOpen(false), className: ({ isActive }) => getNavLinkClass(isActive), children: [_jsx(item.icon, { className: "h-6 w-6 shrink-0", "aria-hidden": "true" }), item.name] }) }, item.name))) }) }) }) })] })] }) }) })] }) }), _jsx("div", { className: "hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col", children: _jsxs("div", { className: "flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 pb-4", children: [_jsx("div", { className: "flex h-16 shrink-0 items-center", children: _jsx("span", { className: "text-xl font-bold text-white tracking-tight", children: "ScheduleCentral" }) }), _jsx("nav", { className: "flex flex-1 flex-col", children: _jsxs("ul", { role: "list", className: "flex flex-1 flex-col gap-y-7", children: [_jsx("li", { children: _jsx("ul", { role: "list", className: "-mx-2 space-y-1", children: filteredNav.map((item) => (_jsx("li", { children: _jsxs(NavLink, { to: item.href, className: ({ isActive }) => getNavLinkClass(isActive), children: [_jsx(item.icon, { className: "h-6 w-6 shrink-0", "aria-hidden": "true" }), item.name] }) }, item.name))) }) }), _jsxs("li", { className: "mt-auto", children: [_jsxs("a", { href: "#", className: "group -mx-2 flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-gray-400 hover:bg-gray-800 hover:text-white", children: [_jsx("div", { className: "h-8 w-8 rounded-full bg-gray-800 flex items-center justify-center border border-gray-600 text-white", children: _jsx("span", { className: "text-xs font-medium", children: session.userName.charAt(0).toUpperCase() }) }), _jsx("span", { className: "sr-only", children: "Your profile" }), _jsx("span", { "aria-hidden": "true", children: session.userName })] }), _jsx("form", { action: "/Identity/Account/Logout?returnUrl=%2F", method: "post", className: "mt-2", children: _jsxs("button", { type: "submit", className: "group -mx-2 flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-gray-400 hover:bg-gray-800 hover:text-red-400 w-full text-left transition-colors duration-150", children: [_jsx(ArrowLeftOnRectangleIcon, { className: "h-6 w-6 shrink-0", "aria-hidden": "true" }), "Log out"] }) })] })] }) })] }) }), _jsxs("div", { className: "lg:pl-72", children: [_jsxs("div", { className: "sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8", children: [_jsxs("button", { type: "button", className: "-m-2.5 p-2.5 text-gray-700 lg:hidden", onClick: () => setSidebarOpen(true), children: [_jsx("span", { className: "sr-only", children: "Open sidebar" }), _jsx(Bars3Icon, { className: "h-6 w-6", "aria-hidden": "true" })] }), _jsxs("div", { className: "flex flex-1 gap-x-4 self-stretch lg:gap-x-6", children: [_jsx("div", { className: "flex flex-1 items-center", children: _jsx("h1", { className: "text-2xl font-semibold text-gray-900", children: ((_a = filteredNav.find(item => item.href === location.pathname)) === null || _a === void 0 ? void 0 : _a.name) || "Dashboard" }) }), _jsxs("div", { className: "flex items-center gap-x-4 lg:gap-x-6", children: [_jsx("div", { className: "hidden lg:block lg:h-6 lg:w-px lg:bg-gray-900/10", "aria-hidden": "true" }), _jsx("span", { className: "text-sm font-semibold leading-6 text-gray-900", children: session.roles[0] || 'User' })] })] })] }), _jsx("main", { className: "py-10", children: _jsx("div", { className: "px-4 sm:px-6 lg:px-8", children: _jsx("div", { className: "bg-white rounded-lg shadow min-h-[80vh] p-6 border border-gray-200", children: children }) }) })] })] }));
};
export default DashboardLayout;
